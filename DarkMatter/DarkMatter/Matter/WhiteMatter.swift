...
private let syntheticTracks: [Track] = [
    Track(name: "Breathing Spears", fileName: "BreathingSpears"),
    Track(name: "White Beach",      fileName: "WhiteBeach"),
    Track(name: "Pure White Matter", fileName: "PureWhiteMatter"),
]

// MARK: – Main view
public struct WhiteMatter: View {
...
#Preview {
    ...
    WhiteMatter(viewModel: PlayerViewModel())
}
